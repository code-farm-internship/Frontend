    ...
    return (
        <>
            <Dropdown menu={{ items: GetUserToolbarItems() }}>
                <div className='group hidden cursor-pointer items-center p-2 text-gray-600 transition-colors md:flex'>
                    <UserOutlined className='text-xl' />
                    <span className='ml-2 hidden w-20 truncate group-hover:text-primary lg:inline'>
